  ...
  return (
    <section className="section-padding bg-coastal-50 border-b border-coastal-100">
      <div className="container-wide">
        ...
        <h2 className="section-title mt-2">Browse Rhodes by the day you want</h2>
        <p className="section-subtitle">
          Medieval Rhodes, Lindos and its Acropolis, the coast and beaches, and island flavours with
          private touring — with the practical detail a cruise day requires.
        </p>
