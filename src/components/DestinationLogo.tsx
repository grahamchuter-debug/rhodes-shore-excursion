...
function MarkSvg({
  ...
  // Concept A (active): Anchor Arch — Rhodes harbour arch meeting a restrained anchor.
  return (
    <svg
      width={size}
      height={size}
 ...
 *
 * Logo refinement: icon slightly subordinate to RHODES,
 * tighter icon–text gap, strapline as light tracked caps.
 */
export function DestinationLogo({
  ...
  const onDark = tone === "on-dark";
  // ~12% smaller than the first prototype so the destination name stays dominant
