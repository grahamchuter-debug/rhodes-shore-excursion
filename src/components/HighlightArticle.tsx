...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="From Rhodes Cruise Port" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {(page.slug === "palace-of-the-grand-master" || page.slug === "anthony-quinn-bay-rhodes") && (
            <SignatureExperienceCallout
              context={page.slug === "palace-of-the-grand-master" ? "old-town" : "lindos"}
            />
          )}

          {related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">More Rhodes guides</h2>
          ...
          <div className="mt-12">
            <FAQSection faqs={page.faqs} title={`${page.attractionName} from Rhodes — FAQs`} />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
