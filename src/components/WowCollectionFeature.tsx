      ...
      <div className="container-wide">
        <div className="card-signature grid gap-0 overflow-hidden border-white/10 bg-white/5 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center p-8 sm:p-10 lg:p-12">
            <p className="section-eyebrow text-coastal-200">Future Rhodes exclusives</p>
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/70">
              The collection is still in preparation. Proposed experiences include an Exclusive Lindos
              day, an Old Town After Hours walk and a private Rhodes and Symi route. None should be
              treated as currently bookable until partners, access and sailing-specific logistics are confirmed.
            </p>

            <div className="mt-6 grid gap-2 sm:grid-cols-2">
              {wowCollection.plannedExperiences.map((item) => (
                <div key={item.title} className="flex items-start gap-2 text-sm text-white/80">
                  <span aria-hidden="true">✨</span>
                  <span>Future {item.title} concept</span>
                </div>
              ))}
