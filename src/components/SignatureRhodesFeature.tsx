...
export function SignatureRhodesFeature({ embedded = false }: { embedded?: boolean }) {
    ...
    <div className="card-signature grid gap-0 overflow-hidden lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center p-8 sm:p-10 lg:p-12">
        ...
        <p className="mt-4 text-base leading-relaxed text-gray-600 italic">
          &ldquo;{rhodesSignatureExperience.tagline}&rdquo;
        </p>
        <p className="mt-4 text-sm leading-relaxed text-gray-700">
          {comingSoon
            ...
            : "The experience we would honestly recommend to a first-time cruise passenger who wants the very best of Rhodes in a single port day."}
        </p>
        ...
        {comingSoon ? (
          <div className="placeholder-widget mt-6 text-left">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Lindos&apos; Acropolis, medieval Rhodes Old Town, a coastal viewpoint stop and a local lunch
              — proposed as a small-group day with cruise-first timing. Register your interest to hear
              when the concept is ready.
            </p>
          </div>
        ) : (
          <div className="mt-6 grid gap-2 sm:grid-cols-2">
            {rhodesSignatureExperience.benefits.slice(0, 4).map((b) => (
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href={SIGNATURE_EXPERIENCE_PATH} className="btn-accent">
            {comingSoon ? "Learn more →" : `Discover ${rhodesSignatureExperience.title} →`}
          </Link>
          {comingSoon && (
