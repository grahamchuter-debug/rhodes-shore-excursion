...
const navItems = [
  ...
  { href: "/rhodes-old-town-or-lindos/", label: "Old Town or Lindos" },
  { href: "/rhodes-cruise-port-guide/", label: "Port Guide" },
  { href: "/lindos-from-rhodes-cruise-port/", label: "Lindos" },
  { href: "/rhodes-cruise-schedule/", label: "Schedules" },
