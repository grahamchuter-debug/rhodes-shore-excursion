...
interface SignatureExperienceCalloutProps {
  context?: "lindos" | "old-town" | "general";
  compact?: boolean;
}

const CONTEXT_COPY = {
  lindos: "Considering Lindos? Our future Rhodes Signature Experience is being designed as a carefully paced small-group Lindos and Old Town day.",
  "old-town": "Exploring the Old Town? Our future Wow Collection will add distinctive small-group Rhodes routes developed around cruise timings.",
  general: "Our future flagship Rhodes Signature Experience is a proposed small-group Lindos and Old Town day. It is still in preparation.",
};
...
export function SignatureExperienceCallout({ context = "general", compact = false }: SignatureExperienceCalloutProps) {
  ...
  const comingSoon = rhodesSignatureExperience.comingSoon;
  ...
  if (compact) {
    return (
      <div className="card-signature mt-10">
        ...
        <h2 className="mt-4 font-display text-xl font-bold text-gray-900">{rhodesSignatureExperience.title}</h2>
    ...
    <div className="card-signature mt-10 grid gap-6 lg:grid-cols-[1.2fr_1fr] lg:items-center">
      <div>
        ...
        <h2 className="mt-4 font-display text-2xl font-bold text-gray-900 sm:text-3xl">
          {rhodesSignatureExperience.title}
        </h2>
