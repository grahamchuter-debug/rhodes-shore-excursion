...
export const metadata = buildMetadata({
  ...
  path,
  image: image.src,
  imageAlt: "The Wow Collection — future exclusive shore excursions from Rhodes",
  keywords: [
    "Wow Collection",
    "Rhodes shore excursions",
    "small group Rhodes tour",
      ...
      <section className="section-padding bg-white">
        <div className="container-wide max-w-4xl">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            ...
            <Link href="/compare/best-rhodes-shore-excursions" className="btn-secondary">
