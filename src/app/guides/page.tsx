...
const path = "/guides";
const description =
  "Rhodes cruise planning guides — medieval Old Town, Lindos and its Acropolis, the coast, Kamiros and practical port-day advice.";

export const metadata = buildMetadata({
  title: "Rhodes Cruise Planning Guides",
  description,
  path,
  keywords: [
    "Rhodes cruise port guide",
    "Lindos from Rhodes",
    "Rhodes shore excursions guide",
    "Rhodes Old Town guide",
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({ title: "Rhodes Cruise Planning Guides", description, path }),
        ]}
      />
      <PageHero
        title="Rhodes Cruise Planning Guides"
        subtitle="Medieval Rhodes Old Town, Lindos and its Acropolis, the coast and practical advice for every type of cruise passenger."
      ...
      <section className="section-padding">
        <div className="container-wide">
          ...
          <p className="section-subtitle">Practical guides to Rhodes&apos; highlights with transfer times and return-to-ship advice.</p>
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {guidePages.map((g) => {
              ...
              return (
                <Link key={g.slug} href={`/${g.slug}/`} className="card-editorial group overflow-hidden">
                  <div className="relative aspect-[16/9] overflow-hidden">
                    <ResponsiveImage
                      image={img}
                      role="card"
