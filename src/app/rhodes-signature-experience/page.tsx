...
import { rhodesSignatureExperience, SIGNATURE_EXPERIENCE_PATH } from "@/data/signature-experience";
import { subjectImages } from "@/lib/images";
import { ResponsiveImage } from "@/components/ResponsiveImage";
import { PreloadImage } from "@/components/PreloadImage";

const path = SIGNATURE_EXPERIENCE_PATH;
const image = subjectImages.photography;

export const metadata = buildMetadata({
  title: rhodesSignatureExperience.seoTitle,
  description: rhodesSignatureExperience.metaDescription,
  path,
  image: image.src,
  imageAlt: "Lindos and Rhodes Old Town — future Signature Experience from Rhodes cruise port",
  keywords: [
    "Rhodes Signature Experience",
    "Rhodes shore excursions",
    "small group Lindos tour",
...
const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Rhodes Signature Experience", path },
];

export default function RhodesSignatureExperiencePage() {
  return (
    <>
      <JsonLd
        data={[
          breadcrumbSchema(breadcrumbs),
          faqSchema(rhodesSignatureExperience.faqs),
          articleSchema({
            title: rhodesSignatureExperience.seoTitle,
            description: rhodesSignatureExperience.metaDescription,
            path,
      ...
      <section className="section-signature-hero">
        ...
        <div className="container-wide relative z-10 px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <h1 className="home-hero-heading mt-6 max-w-3xl">{rhodesSignatureExperience.title}</h1>
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-white/90">
            {rhodesSignatureExperience.tagline}
          </p>
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/75">
            {rhodesSignatureExperience.overview}
          </p>
        ...
        <div className="container-wide max-w-4xl">
          ...
          <div className="placeholder-widget mt-8">
            ...
            <p className="mt-3 text-gray-700 leading-relaxed">
              ...
              launched, it will become the primary recommendation on this site — designed for a small
              group, cruise-timed routing and a carefully paced Lindos and Old Town day. It is a
              concept in preparation, not a currently bookable excursion.
            </p>
          </div>

          <div className="mt-10 grid gap-3 sm:grid-cols-2">
            {rhodesSignatureExperience.benefits.map((b) => (
          ...
          <div className="mt-12">
            <FAQSection faqs={rhodesSignatureExperience.faqs} title="Rhodes Signature Experience — FAQs" />
          </div>

          <div className="mt-10 flex flex-wrap gap-3">
            <Link href="/best-rhodes-shore-excursions/" className="btn-secondary">
