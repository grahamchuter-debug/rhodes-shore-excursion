...
export function buildMetadata({
  ...
  return {
    ...
    keywords: [
      ...
      "Rhodes Old Town shore excursions",
      "Rhodes cruise port",
      ...keywords,
    ],
...
/** Root-level guide pages (e.g. /rhodes-old-town-from-cruise-port/) rather than /guides/[slug]. */
export function guideRootPageMetadata(slug: string, title: string, description: string, imageKey: string) {
  const image = getGuideImage(imageKey);
  return buildMetadata({
    title,
    description,
